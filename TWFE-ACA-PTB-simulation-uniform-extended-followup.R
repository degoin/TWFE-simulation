...
results_df <- read.csv(file="./results/twfe_uniform_extended_sim_results_PTB_n1000_12092022.csv")
...
write.csv(results_df_summary, file="./results/twfe_uniform_sim_results_extended_followup_summary_PTB_n1000_12092022.csv", row.names = F)

...
write.csv(results_df, file="./results/twfe_uniform_extended_sim_results_PTB_n1000_05272022.csv", row.names = F)
...
write.csv(results_df_summary, file="./results/twfe_uniform_sim_results_extended_followup_summary_PTB_n1000_05272022.csv", row.names = F)

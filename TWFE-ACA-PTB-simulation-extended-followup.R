...
write.csv(results_df, file="../TWFE-simulation/results/twfe_sim_results_PTB_ext_n1000_07112022.csv", row.names = F)


results_df <- read.csv("./results/twfe_sim_results_PTB_ext_n1000_12092022.csv")
...
write.csv(results_df_summary, file="./results/twfe_sim_results_extended_followup_summary_PTB_n1000_ext_12092022.csv", row.names = F)

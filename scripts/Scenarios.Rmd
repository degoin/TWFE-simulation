---
title: "Companion Guide to 'INSERT TITLE HERE'"
output: 
  html_document:
    toc: true
    toc_float: true
...
Please use the following citation when using this website: Goin DE, Riddell CA (2022). INSERT TITLE HERE. Pre-print. ADD LINK.

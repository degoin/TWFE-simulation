...
8. Let's see how the weights from the Bacon decomposition for Scenario 9 compare
to Scenario 8. 
...
### Ben-Micheal Approach

```{r, include = F, eval = F}
source("../helper_func_ed.R")

all_states2$time_first_treat3 <- all_states2$time_first_treat
all_states2$time_first_treat3[all_states2$time_first_treat == 0] <- NA

#add dates for the date_var 


m4 <- fit_event_jack(outcome_var = "outcome", 
                         date_var = "time", 
                         unit_var = "state",

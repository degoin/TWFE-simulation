...
Same as above but limit the pre-time
...
Add sentence about how length of pre-time affects the TWFE estimate
...
[See that the weights are all different]

[Add in the CS and other approaches]

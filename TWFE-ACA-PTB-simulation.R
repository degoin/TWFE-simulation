...
write.csv(results_df, file="./results/twfe_sim_results_PTB_n1000_12062022.csv", row.names = F)

# CORINNE COMMENTED ALL THE REST OUT BECAUSE GETTING AN ERROR....
results_df <- read.csv(file="./results/twfe_sim_results_PTB_n1000_12062022.csv")

...
ggsave(p3, file="../TWFE-simulation/results/twfe_sim_mse_PTB_n100.png", 
       width=15, height = 5, device = "png")
...
p4
ggsave(p4, file="../TWFE-simulation/results/twfe_sim_power_PTB_n100.png", 
       width=15, height = 5, device = "png")
...
ggsave(p41, file="../TWFE-simulation/results/dyn_coverage_n100.png", 
...
ggsave(p51, file="../TWFE-simulation/results/dyn_bias_n100_PTB.png", 
       width=12,height = 4, device = png)
...
ggsave(p61, file="../TWFE-simulation/results/dyn_mse_n100_PTB.png", 
       width=12,height = 4, device = png)
...
ggsave(p71, file="../TWFE-simulation/results/dyn_power_n100_PTB.png", 
       width=12, height = 4, device = png)

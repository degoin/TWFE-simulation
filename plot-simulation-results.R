...
results_df_summary <- read.csv("../TWFE-simulation/results/twfe_sim_results_summary_PTB.csv")
...
ggsave(p1, file="../TWFE-simulation/results/twfe_sim_coverage_PTB.pdf", width=10)
